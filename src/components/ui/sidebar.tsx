...
function Sidebar({
  ...
  return (
    <div
      className="group group/sidebar peer text-sidebar-foreground hidden md:block"
      data-state={state}
...
function SidebarMenuSub({ className, ...props }: React.ComponentProps<"ul">) {
  return (
    <ul
      ...
      className={cn(
        "border-[var(--ds-neutral-2)]/50 mx-3.5 flex min-w-0 translate-x-px flex-col gap-1 border-l px-2.5 py-0.5",
        "group-data-[collapsible=icon]:hidden",
        className
      )}
      {...props}
