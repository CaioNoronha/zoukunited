const tickets = {
  ...
  items: {
    ...
    buddy: {
      ...
      description:
        "Two full passes with one purchase for a partner or two leaders.",
    },
    jackJill: {
      title: "BZDC Jack & Jill",
      price: "$30.00",
      availability: "Available until 2026/02/06 23:59",
      description: "Official BZDC Jack & Jill (all levels). Full Pass required.",
    },
    preParty: {
      title: "Pre-Party Pass",
      price: "$30.00",
      availability: "Available until 2026/01/31 23:59",
      description: "Thursday pre-party with two workshops and the opening social.",
    },
  },
};
